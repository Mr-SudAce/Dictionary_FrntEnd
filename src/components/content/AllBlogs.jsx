        ...
        <>
            <div className="flex flex-col m-3 space-y-4">
                {allblogs.map((allblog, index) => {
                    // Format each blog's created_at date
                    const date = new Date(allblog?.created_at);
                                        ...
                                        <div className="md:flex-grow">
                                            ...
                                            <p
                                                ...
                                                dangerouslySetInnerHTML={{
                                                    __html: `${allblog.blog_description
                                                        .substring(0, 200)
                                                        .split(" ")
                                                        .slice(0, -1)
                                                        .join(" ")}...`,
                                            ...
                                            ></p>
                                            <Link to={`/blog/${allblog.id}`} className="inline-flex items-center">
                                                Learn More..
                                            </Link>
                                        </div>
                                    </div>
